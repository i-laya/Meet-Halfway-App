...
//        }
        ...
        client.searchWithGeoCoordinate(YLPGeoCoordinate(latitude: midpointCoordinates.latitude, longitude: midpointCoordinates.longitude, accuracy: 0, altitude: 0, altitudeAccuracy: 0), currentLatLong: MidpointHelper.assignMidpoint().yelpCoordinate, term: "restaurants", limit: 5, offset: 0, sort: .Distance) { (search: YLPSearch?,error: NSError?) -> Void in
